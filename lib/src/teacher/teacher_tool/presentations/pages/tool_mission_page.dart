...
class _ToolMissionPageState extends State<ToolMissionPage> {
  ...
  Widget _mission(ToolProvider provider) => ListView.builder(
    ...
    itemBuilder: (context, index) => InkWell(
      onTap: () {
        final mission = provider.missionListModel!.data!.missions!.data![index];
        MixpanelService.track("MissionListingScreen_MissionClicked", properties: {
  ...
  Widget _topic(ToolProvider provider) => ListView.builder(
    ...
    itemBuilder: (context, index) => InkWell(
      onTap: () {
        final topic = provider.topicModel!.data!.laTopics![index];
        MixpanelService.track("MissionListingScreen_MissionClicked", properties: {
