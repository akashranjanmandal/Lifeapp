                    ...
                    children: [
                      Expanded(
                        child: CustomTextField(
                          ...
                          onChange: (val) => provider.updateSchoolCode(val),
                        ),
                      ),
...
// === Dynamic Grade-Section-Subject Fields ===
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    CustomTextField(
                                      ...
                                      onTap: () => teacherProfileGradeListBottomSheet(context, provider, e),
                                    ),
                                    const SizedBox(height: 20),
                                    ...
                                    CustomTextField(
                                      ...
                                      onTap: () => teacherProfileSectionListBottomSheet(context, provider, e),
                                    ),
                                    const SizedBox(height: 20),
                                    ...
                                    CustomTextField(
                                      ...
                                      onTap: () => teacherSubjectListBottomSheet(context, provider, e),
                                    ),
                                  ],
                                ),
                              ),
                  ...
                  CustomTextField(
                    ...
                    onTap: () => teacherBoardListBottomSheet(context, provider),
                  ),
                  const SizedBox(height: 28),
