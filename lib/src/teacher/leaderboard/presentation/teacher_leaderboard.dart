          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  _styledChoiceChip(label: 'Teacher Board', selected: isTeacherView, onTap: () => _onSwitch(true)),
                  const SizedBox(width: 8),
                  _styledChoiceChip(label: 'School Board', selected: !isTeacherView, onTap: () => _onSwitch(false)),
                ],
              ),
