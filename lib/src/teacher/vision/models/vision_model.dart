...
class ChapterInfo {
  final int id;
  final String title;
  final String? laBoardId;
  final String? laGradeId;
  ...
  factory ChapterInfo.fromJson(Map<String, dynamic> json) {
    return ChapterInfo(
      id: json['id'] ?? 0,
      title: json['title']?.toString() ?? '',
      laBoardId: json['la_board_id']?.toString(),
      laGradeId: json['la_grade_id']?.toString(),
...
class TeacherVisionVideo {
  ...
  final String? laSubjectId;
  final String? laBoardId; // New: Board ID
  final BoardInfo? boardInfo; // New: Board Info
  final String level;
  ...
  String get boardDisplay => boardInfo?.displayName ?? laBoardId ?? '';
  ...
  factory TeacherVisionVideo.fromJson(Map<String, dynamic> json) {
    ...
    // Board
    BoardInfo? boardInfo;
    if (json['board'] != null && json['board'] is Map<String, dynamic>) {
      boardInfo = BoardInfo.fromJson(json['board']);
    }

    // Thumbnail
    String thumbnail = json['thumbnailUrl']?.toString() ??
        json['thumbnail_url']?.toString() ??
        (getVideoIdFromUrl(json['youtubeUrl']?.toString() ?? json['youtube_url']?.toString() ?? '') != null
            ? getThumbnailUrl(getVideoIdFromUrl(json['youtubeUrl']?.toString() ?? json['youtube_url']?.toString() ?? '')!)
  ...
  @override
  String toString() => 'TeacherVisionVideo(id: $id, title: $title, board: $laBoardId)';
}
